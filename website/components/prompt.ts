 ...
 * model reads whichever page she pasted and the two must not tell it different
 * things. The bracketed part is hers to change; everything else is what makes
...
/** Things she might put in the brackets. */
export const IDEAS = [
