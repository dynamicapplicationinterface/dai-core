...
### SHARED-NO-TRAILING-COMMENT · No comment after a shared table's last column {#SHARED-NO-TRAILING-COMMENT}

**Applies to** passable, session. **Enforcement:** checked by the lint (`shared-trailing-comment`).
