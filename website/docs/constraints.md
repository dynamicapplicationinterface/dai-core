...
- **session** — [SHAPE-FIRST](#SHAPE-FIRST) · [NO-NETWORK](#NO-NETWORK) · [STORE-IN-SQLITE](#STORE-IN-SQLITE) · [MODULE-FOR-AWAIT](#MODULE-FOR-AWAIT) · [NO-INLINE-HANDLERS](#NO-INLINE-HANDLERS) · [NO-NEW-WINDOWS](#NO-NEW-WINDOWS) · [ONE-DOCUMENT](#ONE-DOCUMENT) · [SHARE-THROUGH-HOST](#SHARE-THROUGH-HOST) · [SCHEMA-FILE](#SCHEMA-FILE) · [SEED-IDEMPOTENT](#SEED-IDEMPOTENT) · [WRITE-AS-IT-HAPPENS](#WRITE-AS-IT-HAPPENS) · [NO-INPUT-LOST-WHILE-OPENING](#NO-INPUT-LOST-WHILE-OPENING) · [NO-SAVE-BUTTON](#NO-SAVE-BUTTON) · [MIGRATE-CHANGED-TABLES](#MIGRATE-CHANGED-TABLES) · [TIMES-IN-UTC](#TIMES-IN-UTC) · [SHARED-MARKER](#SHARED-MARKER) · [SHARED-DECIDE-UP-FRONT](#SHARED-DECIDE-UP-FRONT) · [SHARED-NO-KEY](#SHARED-NO-KEY) · [SHARED-NO-UNIQUE-CHECK](#SHARED-NO-UNIQUE-CHECK) · [SHARED-NO-R-COLUMNS](#SHARED-NO-R-COLUMNS) · [SHARED-WRITE-SURFACE](#SHARED-WRITE-SURFACE) · [SHARED-READ-CURRENT](#SHARED-READ-CURRENT) · [SHARED-SURFACE-CONFLICTS](#SHARED-SURFACE-CONFLICTS) · [SHARED-REDRAW-ON-MERGE](#SHARED-REDRAW-ON-MERGE) · [SHARED-NO-DERIVED-STATE](#SHARED-NO-DERIVED-STATE) · [SHARED-LOCAL-STAYS-LOCAL](#SHARED-LOCAL-STAYS-LOCAL) · [SHARED-ENTITY-IDENTITY](#SHARED-ENTITY-IDENTITY) · [SHARED-SEED-THROUGH-SURFACE](#SHARED-SEED-THROUGH-SURFACE) · [SHARED-NEEDS-HOST](#SHARED-NEEDS-HOST) · [SESSION-PROFILE](#SESSION-PROFILE) · [SESSION-CREATE](#SESSION-CREATE) · [SESSION-ROW-CARRIES-SESSION](#SESSION-ROW-CARRIES-SESSION) · [SESSION-JOIN-ON-OPEN](#SESSION-JOIN-ON-OPEN) · [SESSION-MEMBERSHIP](#SESSION-MEMBERSHIP) · [SESSION-CONTESTED-SEAT](#SESSION-CONTESTED-SEAT) · [SESSION-CLOSE](#SESSION-CLOSE) · [SESSION-INVITE](#SESSION-INVITE) · [KIT-FIRST](#KIT-FIRST) · [SHARED-KIT-READS](#SHARED-KIT-READS) · [ICON-SVG](#ICON-SVG) · [DESCRIBE-ON-CARD](#DESCRIBE-ON-CARD) · [EDGE-TO-EDGE](#EDGE-TO-EDGE) · [TOP-RIGHT-CLEAR](#TOP-RIGHT-CLEAR) · [ONE-LAYOUT](#ONE-LAYOUT) · [LOOK-FINISHED](#LOOK-FINISHED) · [HANDOVER-BUNDLE](#HANDOVER-BUNDLE)
...
<small>Depends on [`tests/fixture/chess/app.js`](https://github.com/dynamicapplicationinterface/dai-core/blob/main/tests/fixture/chess/app.js), [`examples/receipts/index.html`](https://github.com/dynamicapplicationinterface/dai-core/blob/main/examples/receipts/index.html), [`src/kit.ts`](https://github.com/dynamicapplicationinterface/dai-core/blob/main/src/kit.ts).</small>
