...
export default defineConfig([
  ...
  {
    entry: ["src/index.ts", "src/core.ts", "src/container.ts", "src/compile.ts", "src/cli.ts", "src/bin.ts", "src/browser.ts", "src/lint.ts", "src/recipe.ts", "src/mcp.ts", "src/mcp-bin.ts"],
    format: ["esm", "cjs"],
