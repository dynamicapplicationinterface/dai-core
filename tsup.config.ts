...
export default defineConfig([
  ...
  {
    entry: ["src/index.ts", "src/core.ts", "src/container.ts", "src/link.ts", "src/inline.ts", "src/p256.ts", "src/kit.ts", "src/store.ts", "src/unfurl.ts", "src/store-fs.ts", "src/store-s3.ts", "src/env.ts", "src/x509.ts", "src/identity.ts", "src/sender.ts", "src/compile.ts", "src/cli.ts", "src/bin.ts", "src/browser.ts", "src/lint.ts", "src/recipe.ts", "src/format.ts", "src/cbor.ts", "src/cose.ts", "src/mcp.ts", "src/mcp-bin.ts"],
    format: ["esm", "cjs"],
